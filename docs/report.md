...
- **型別映射**：將 semantic 層的型別映射到 LLVM IR 型別，包含 `i8`、`i16`、`i32`、`i64`、`float`、`double`、`x86_fp80`、pointer、array、struct 與 function。
...
** 因為採用最新的 mingw gcc 編譯器 所以有很大可能在別的電腦上會遇到很多問題，有可能無法正確執行，如果老師 or 助教遇到，拜託先聯絡我，不要把我當掉。

# 參考文獻

- [LLVM Project Documentation](https://llvm.org/docs/) (llvm 相關參考)
- [WG21 P2996R：Reflection for C++26](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2024/p2996r8.html) (c++26 反射相關提案)
- [C++26 静态反射提案解析](https://zhuanlan.zhihu.com/p/661692275) (中文 c++26 反射參考)
- [Aleksey Kladov, “Simple but Powerful Pratt Parsing”](https://matklad.github.io/2020/04/13/simple-but-powerful-pratt-parsing.html) (Pratt parser 參考)

- [fatbrother/toyc](https://github.com/fatbrother/toyc) (學長的編譯器專案1)
- [fatbrother/DDLBX](https://github.com/fatbrother/DDLBX) (學長的編譯器專案2)
- [lkvlkvlkv/compiler_hw](https://github.com/lkvlkvlkv/compiler_hw) (學長的編譯器專案3)
